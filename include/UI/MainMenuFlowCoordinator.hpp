...
DECLARE_CLASS_CODEGEN(ScoreSaber::UI, MainMenuFlowCoordinator, HMUI::FlowCoordinator,
                      ...
                      DECLARE_INSTANCE_FIELD_DEFAULT(ScoreSaberUI::UI::ViewControllers::GlobalViewController*, globalViewController, nullptr);
                      DECLARE_INSTANCE_FIELD_DEFAULT(ScoreSaberUI::UI::ViewControllers::FAQViewController*, faqViewController, nullptr);
